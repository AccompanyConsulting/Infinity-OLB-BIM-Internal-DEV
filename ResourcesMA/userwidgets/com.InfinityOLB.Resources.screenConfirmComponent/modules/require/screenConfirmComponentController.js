		...
		onClickRowExpand: function () {
			...
			if (currentForm.id !== "frmFastP2P") {
				if (kony.application.getCurrentBreakpoint() == 640) {
					currentForm.screenConfirm.segContracts.sectionHeaderTemplate = "flxContractConfirmScreenRowTemplateMobile";
					currentForm.screenConfirm.segContracts.setActive(-1, selectedRowIndex, "flxContractConfirmScreenRowTemplate.flxUserCommonRowHeader.flxDropDown");
				}
				currentForm.screenConfirm.segContracts.sectionHeaderTemplate = "flxContractConfirmScreenRowTemplate";
				currentForm.screenConfirm.segContracts.setActive(-1, selectedRowIndex, "flxContractConfirmScreenRowTemplate.flxGroup1.flxUserCommonRowHeader.flxContent.flxDropDown");
			}
		},
