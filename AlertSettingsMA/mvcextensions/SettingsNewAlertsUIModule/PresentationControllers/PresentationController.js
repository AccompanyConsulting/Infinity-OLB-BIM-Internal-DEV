...
//         }
    ...
    SettingsNew_PresentationController.prototype.updateAlertsSuccess = function(responseData) {
      this.refreshAccountsFromServer(applicationManager.getUserPreferencesManager().getCurrentUserName());
...
/**
  ...
  SettingsNew_PresentationController.prototype.fetchAccounts = function(userName) {
    if (Array.isArray(this.accounts) && this.accounts.length === 0) {
      this.refreshAccountsFromServer(userName);
    }
  };

  SettingsNew_PresentationController.prototype.refreshAccountsFromServer = function(userName) {
