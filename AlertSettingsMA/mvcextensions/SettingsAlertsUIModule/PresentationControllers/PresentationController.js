...
*/
  ...
  */
  ...
  Settings_PresentationController.prototype.presentationFetchAccountsForAlertsSucc = function(accountsAlertsData, resSuccess){
    ...
    let accountStatusMap = {}, accountsAlertsFilteredData = [];;
    ...
    for (accountAlertIndex in accountsAlertsData) {
      let accountAlertObj = {}, accountAlert = {};
      if(isSingleCustomerProfile) {
         accountAlert = accountsAlertsData[accountAlertIndex];
      } else {
         Object.assign(accountAlertObj, accountsData[accountAlertIndex]); 
         accountAlertObj.isEnabled = accountsAlertsData[accountAlertIndex].isEnabled;
         accountAlert = accountAlertObj;
      }
