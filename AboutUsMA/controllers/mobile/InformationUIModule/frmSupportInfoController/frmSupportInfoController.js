    ...
    preShow: function () {
        ...
        if (headerValue === configManager.constants.FAQ) {
          ...
          if(kony.theme.getCurrentTheme() === "darkTheme"){
            let preAppend ='<!DOCTYPE html><html lang="en"><head><style>body{background-color: #0a0a0a;color: #eeeeee;}</style></head><body>';
            let postAppend = '</body></html>'
            populateData = preAppend + populateData + postAppend;
          }
            this.searchStatus.isSearchBoxVisible = false;
