define(['CommonUtilities','OLBConstants','SCAConfiguration', 'SCAUnikenConfiguration'], function(CommonUtilities,OLBConstants,SCAConfiguration, SCAUnikenConfiguration) {
          ...
          if(isCombinedUser){
            ...
            if (personalEmailIdCount < 3) {
                ...
                if (CommonUtilities.getSCAType() == 0) {
                  ...
                  let action = SCAUnikenConfiguration.ADD_NEW_EMAIL;
                  SCAUnikenConfiguration.sendSCANotificationRequest(params, action, this.fetchUser.bind(this, "EmailIds"), this.saveEmailFailureCallBack.bind(this));
                }
            } else {
  ...
  /**
    ...
    SettingsNew_PresentationController.prototype.editEmail = function(Context,isMFARequired) {
        ...
        if (CommonUtilities.getSCAType() == 0) {
          ...
          let action = SCAUnikenConfiguration.UPDATE_EMAIL_ADDRESS
          SCAUnikenConfiguration.sendSCANotificationRequest(params, action, this.editEmailSuccess.bind(this), this.editEmailFailure.bind(this));
        }
    };
  ...
  SettingsNew_PresentationController.prototype.updateUsername = function(userName) {
   ...
   SettingsNew_PresentationController.prototype.updateUsernameSuccess = function(response) {
    ...
    SettingsNew_PresentationController.prototype.getPreferredAccounts = function(){
        ...
        */
        applicationManager.getAccountManager().updateInternalAccounts = false;
        applicationManager.getAccountManager().fetchInternalAccounts(this.fetchAccountsSuccess.bind(this), this.fetchAccountsFailure.bind(this));
    }
    /**
  ...
  /**
    ...
    SettingsNew_PresentationController.prototype.fetchAlertsCategory = function(entryPoint,accountID) {
        ...
        if(entryPoint=="profileSettings"){
          ...
          if (CommonUtilities.getSCAType() == 1) {
            ...
            // Navigation for UNIKEN
            applicationManager.getNavigationManager().navigateTo({ "appName": "ManageProfileMA", "friendlyName": "frmDeviceManagementUniken" });
          }
    ...
    SettingsNew_PresentationController.prototype.showDeviceManagementScreen = function() {
      if (CommonUtilities.getSCAType() == 1) {
        ...
        applicationManager.getNavigationManager().updateForm({ "isLoading": false, "showRegisteredDevices": true }, 'frmDeviceManagementHID');
      } else if (CommonUtilities.getSCAType() == 2) {
        // Navigation for UNIKEN
        applicationManager.getNavigationManager().navigateTo({ "appName": "ManageProfileMA", "friendlyName": "SettingsUnikenUIModule/frmDeviceManagementUniken" });
        applicationManager.getNavigationManager().updateForm({ "isLoading": false, "showRegisteredDevices": true }, 'frmDeviceManagementUniken');
      }
    };
...
SettingsNew_PresentationController.prototype.sortSegmentDataforAccountLevel = function(segmentData, sectionIndex, imgWidget, sortKey){
  ...
  SettingsNew_PresentationController.prototype.getUsernameRulesAndPoliciesFailure = function() {
   ...
   SettingsNew_PresentationController.prototype.showUserNameAndPassword = function() {
     applicationManager.getNavigationManager().navigateTo({
                "appName": "ManageProfileMA",
                "friendlyName": "SettingsNewUIModule/frmUsernameAndPassword"
            });
      applicationManager.getNavigationManager().updateForm({
   ...
   SettingsNew_PresentationController.prototype.showBankingAccess = function() {
     ...
     SettingsNew_PresentationController.prototype.showBankingAccessSuccess = function(response) {
       applicationManager.getNavigationManager().navigateTo({
                "appName": "ManageProfileMA",
                "friendlyName": "SettingsNewUIModule/frmeBankingAccess"
         });
       applicationManager.getNavigationManager().updateForm({
  ...
  SettingsNew_PresentationController.prototype.showProfileLanguage = function(){
     applicationManager.getNavigationManager().navigateTo({
                "appName": "ManageProfileMA",
                "friendlyName": "SettingsNewUIModule/frmProfileLanguage"
            });
     applicationManager.getNavigationManager().updateForm({"isLoading":true});
...
/**
  ...
  SettingsNew_PresentationController.prototype.createTnC = function (inputParams) {
    params = {
      ...
      "termsAndConditionsCode": inputParams.flowType
    };
  ...
  /**
 * Method used to update default language
 * @param {Object} langSelected - contains the language.
 */
  SettingsNew_PresentationController.prototype.updateDefaultLanguage = function (langSelected) {
    var params = {
      "defaultLanguage": langSelected
    }
    applicationManager.getUserPreferencesManager().updateDefaultLanguage(params, this.updateDefaultLanguageSuccess.bind(this), this.updateDefaultLanguageFailure.bind(this));
  };

  /**
  *Method used as success call back for update language service.
  * @para {Object} response - contains the service response.
  */
  SettingsNew_PresentationController.prototype.updateDefaultLanguageSuccess = function (response) {
    var viewProperties = {
      isLoading: false,
      updatelanguageSuccess : true
    };
    applicationManager.getNavigationManager().updateForm(viewProperties, "frmProfileLanguage");
 
  };

  /**
   * Method used as the failure call back for update language.
   * @param {String} errorMessage - contains the error message.
   */
  SettingsNew_PresentationController.prototype.updateDefaultLanguageFailure = function (errorMessage) {
    var viewProperties = {
      isLoading: false,
      updatelanguageError: errorMessage
    };
    applicationManager.getNavigationManager().updateForm(viewProperties, "frmProfileLanguage");
  };
