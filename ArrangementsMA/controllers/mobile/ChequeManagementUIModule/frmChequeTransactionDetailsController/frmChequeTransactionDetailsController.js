define(['CommonUtilities'], function(CommonUtilities) {
  return {
    ...
    renderChequeBookView:function(data){
      ...
      this.view.lblNumberOfBooks.text=data.bookCount.hasOwnProperty("text")?data.bookCount.text:data.bookCount;
      ...
      if(data.lblDate && data.lblDate.text!="")
        this.view.lblRequestDateValue.text=data.lblDate.hasOwnProperty("text")?data.lblDate.text:data.lblDate;
      else
    ...
    renderStopChequeView:function(data){
      ...
      if(data.payeeName)
       ...
       if (data.lblDate && data.lblDate.text!="") this.view.lblTransferredFromValueTrans.text = data.lblDate.hasOwnProperty("text")?data.lblDate.text:data.lblDate;
      else
    ...
    renderMyChequeView:function(data){
      ...
      if(data.lblAccountNo)
        ...
        this.view.lblPayeeValue.text=data.lblAccountNo="-";
      this.view.lblAmountValue.text=data.lblDate.hasOwnProperty("text")?data.lblDate.text:data.lblDate;
