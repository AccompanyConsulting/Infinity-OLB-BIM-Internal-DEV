define({
 ...
 /*   if(!varPass){
  ...
  initActions: function () {
    ...
    this.view.flxSearchIcon.left="0dp";
    this.view.imgSearch.width="23dp";
    ...
    this.view.btnStopCheck.onClick=scope.renderStopChequeView;
    this.view.btnCheckBooks.onClick=scope.renderChequeBooksView;
    this.view.btnMyChecks.onClick=scope.renderMyChequesView;
  ...
  renderStopChequeView: function() {
    ...
    this.view.btnStopCheck.skin = "ICBtn003E7534px";
    this.view.btnCheckBooks.skin = "ICSknBtnbgFFFFFFfont003E7536px";
    this.view.btnMyChecks.skin = "ICSknBtnbgFFFFFFfont003E7536px";
...
scope_ChequePresentationController.isInitial=true;
  ...
  renderChequeBooksView: function() {
    ...
    // this.view.flxMyChequesLabel.skin = "sknFlxffffffmb";
    // this.view.lblMyCheques.skin="sknlbl003E7536px";
    this.view.btnStopCheck.skin = "ICSknBtnbgFFFFFFfont003E7536px";
    this.view.btnCheckBooks.skin = "ICBtn003E7534px";
    this.view.btnMyChecks.skin="ICSknBtnbgFFFFFFfont003E7536px";
    this.view.flxStopCheques.top="110dp";
  ...
  renderMyChequesView: function() {
    ...
    this.view.btnStopCheck.skin="ICSknBtnbgFFFFFFfont003E7536px";
    this.view.btnCheckBooks.skin="ICSknBtnbgFFFFFFfont003E7536px";
    this.view.btnMyChecks.skin="ICBtn003E7534px";
  ...
  preShow:function(){
    ...
    this.view.btnStopCheck.setVisibility(this.hasStopPaymentFeat);         
	...
	this.view.btnCheckBooks.setVisibility(visibleChequeBooks);    
    
    this.hasViewChequesFeat = configManager.checkUserFeature("VIEW_CHEQUES");
    if (this.hasViewChequesFeat) {this.nbTabs += 1;}
    this.view.btnMyChecks.setVisibility(this.hasViewChequesFeat);
    this.view.flxSearchInfo.setVisibility(this.hasViewChequesFeat);

    var sizeInPercentage = Math.floor(100/this.nbTabs);
    this.view.btnCheckBooks.width = this.view.btnCheckBooks.width = this.view.btnMyChecks.width = sizeInPercentage + "%";
