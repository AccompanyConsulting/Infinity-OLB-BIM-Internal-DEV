define("ArrangementsMA/MortgageServicesUIModule/userfrmConfirmPartialRepaymentController", ['CommonUtilities', 'ViewConstants', 'FormControllerUtility', 'OLBConstants', 'CampaignUtility'], function(CommonUtilities, ViewConstants, FormControllerUtility, OLBConstants, CampaignUtility) {
    ...
    return {
			...
			this.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblShowIcons.onTouchStart = function() {
                if (scope.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblShowIcons.text == 'g') {
                    scope.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblShowIcons.text = 'h';          
                    scope.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblLoanAccountVal.text = details[0].accountID;
                  
                } else {
                    scope.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblShowIcons.text = 'g';
                    scope.view.confirmPartialRepayment.flxContentTCCenter.flxContentMain.flxPaymentDetails.flxPaymentContentDetails.flxLoanAccount.lblLoanAccountVal.text = scope.loadData.loanAccountNumber;
