define("ArrangementsMA/MortgageServicesUIModule/userfrmPartialRepaymentPaymentDetailsController", ['CommonUtilities', 'ViewConstants', 'FormControllerUtility', 'OLBConstants', 'CampaignUtility'], function (CommonUtilities, ViewConstants, FormControllerUtility, OLBConstants, CampaignUtility) {
    ...
    return {
        ...
        postShow: function () {
			...
			this.view.formTemplate12.flxContentTCCenter.lblShowIcon.onTouchStart = function() {
                mortgageDetails = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({
                    "moduleName": "AccountServicesUIModule",
                    "appName": "ArrangementsMA"
                }).presentationController.mortgageDetails;
                if (scopeObj.view.formTemplate12.flxContentTCCenter.lblShowIcon.text == 'h') {
                    scopeObj.view.formTemplate12.flxContentTCCenter.lblShowIcon.text = 'g';
                    scopeObj.view.formTemplate12.flxContentTCCenter.lblLoanAccountVal.text = details[0].accountID;
                } else {
                    scopeObj.view.formTemplate12.flxContentTCCenter.lblShowIcon.text = 'h';
                    scopeObj.view.formTemplate12.flxContentTCCenter.lblLoanAccountVal.text = "********" + details[0].accountID.substr(-4);;
                }
            }
        },
