define("ArrangementsMA/MortgageServicesUIModule/userfrmRepaymentSimulationController", ['CommonUtilities', 'ViewConstants', 'FormControllerUtility', 'OLBConstants', 'CampaignUtility'], function (CommonUtilities, ViewConstants, FormControllerUtility, OLBConstants, CampaignUtility) {
    ...
    return {
        ...
        frmPreShow: function () {
			...
			this.view.formTemplate12.flxContentTCCenter.flxContentMain.flxBody.flxDowntimeWarning.isVisible = false;
            ...
            if (uiData) {
                ...
                if (uiData.error) {
                    ...
                    if (uiData.error.errorMessage) {
                        this.view.formTemplate12.flxContentTCCenter.flxContentMain.flxBody.flxDowntimeWarning.lblDowntimeError.text = uiData.error.errorMessage;
						this.view.formTemplate12.flxContentTCCenter.flxContentMain.flxBody.flxError.isVisible = false;
						this.view.formTemplate12.flxContentTCCenter.flxContentMain.flxBody.flxDowntimeWarning.isVisible = true;	
        ...
        showResult: function () {
            ...
            if (data[0].tbxAmount.text !== "") {
				var balanceAmount = mortgageAccDetails[0].currentBalance.replace("-", "");
                if (Number(data[0].tbxAmount.text) < Number(balanceAmount) && Number(data[0].tbxAmount.text) > 0) {
                    if (data[0].imgRadioBtn1.text === "M") {
