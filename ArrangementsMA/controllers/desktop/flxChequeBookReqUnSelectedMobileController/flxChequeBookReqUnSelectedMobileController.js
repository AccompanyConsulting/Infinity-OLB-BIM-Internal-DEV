define({
    ...
    showSelectedRow: function() {
        ...
        for (i = 0; i < data.length; i++) {
            if (i == rowIndex) {
                ...
                data[i].flxDropdown.accessibilityConfig = {
                    "a11yLabel": "Hide  details for check book request with" + data[i].lblAmount.text,
                    "a11yARIA": {
                      "tabindex": 0,
                      "role": "button",
                      "aria-expanded": true
                ...
                data[i].flxDropdown.accessibilityConfig = {
                    "a11yLabel": "Show more details for check book request with" + data[i].lblAmount.text,
                    "a11yARIA": {
                      "tabindex": 0,
                      "role": "button",
                      "aria-expanded": false
        ...
        this.AdjustScreen();
        kony.application.getCurrentForm().MyRequestsTabs.segTransactions.setActive(rowIndex, -1, "flxChequeBookReqUnSelectedMobile.flxGroup.flxGroup1.flxSegDisputedTransactionRowWrapper.flxWrapper.flxDropdown");
    },
    //UI Code
