define({
    ...
    showSelectedRow: function() {
        ...
        this.AdjustScreen();
        kony.application.getCurrentForm().MyRequestsTabs.segTransactions.setActive(rowIndex, -1, "flxChequeManagementUnSelectedTablet.flxGroup.flxGroup1.flxSegDisputedTransactionRowWrapper.flxSegDisputedTransactionRowWrappers.flxWrapper.flxDropdown");
    },
    //UI Code
