define({
    ...
    showSelectedRow: function() {
        ...
        data[rowIndex].flxDropdown.accessibilityConfig = {
            "a11yLabel": "Show more for check book request with reference number" + data[rowIndex].lblAmount.text,
            "a11yARIA": {
              "tabindex": 0,
              "role": "button",
              "aria-expanded": false
        ...
        this.AdjustScreen();
        kony.application.getCurrentForm().MyRequestsTabs.segTransactions.setActive(rowIndex, -1, "flxChequeBookReqSelectedMobile.flxGroup.flxGroup1.flxSelectedRowWrapper.flxSegDisputedTransactionRowWrapper.flxSegDisputedTransactionRowWrappers.flxWrapper.flxDropdown");
    },
    //UI Code
