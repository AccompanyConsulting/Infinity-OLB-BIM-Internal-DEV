define({
    ...
    showSelectedRow: function() {
        ...
        this.AdjustScreen();
        kony.application.getCurrentForm().MyRequestsTabs.segTransactions.setActive(rowIndex, -1, "flxDisputedChecksUnSelectedWrapperTablet.flxGroup.flxGroup1.flxSelectedRowWrapper.flxSegDisputedTransactionRowWrapper.flxSegDisputedTransactionRowWrappers.flxWrapper.flxDropdown");
    },
