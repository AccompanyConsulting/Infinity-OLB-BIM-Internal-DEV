...
define(['./AccountsDAO','./ParserUtilsManager','./EntitlementUtils'],function(AccountsDAO,ParserUtilsManager,EntitlementUtils) {
  return {
    ...
    setAccountTypeFromContext: function() {
	  ...
	  if(this.context.productType !== undefined){
	  if (this.context.productType.includes("ISLAMIC") && this.accountType === "Checking") {
                this.accountType = "CheckingIslamic";
            } else if (this.context.productType.includes("ISLAMIC") && this.accountType === "Deposit") {
                this.accountType = "DepositIslamic";
            } else if (this.context.productType.includes("ISLAMIC") && this.accountType === "Savings") {
                this.accountType = "SavingsIslamic";
            }
	  }	
    },
    ...
    setTab2Data: function(formatValues) {
      ...
      this.view.FormatValue3Tab2.UpdateCustomProperties(this.setFormattedData(formatValues, this._tab2field3backendmapping, this._tab2field3type, "Value3"));
      this.view.FormatValue4Tab2.UpdateCustomProperties(this.setFormattedData(formatValues, this._tab2field4backendmapping, this._tab2field4type, "Value4"));
    ...
    setTab3Data: function(formatValues) {
	  var currentBreakPoint = kony.application.getCurrentBreakpoint();
	  formatValues.textSkin =  JSON.stringify(this.breakPointParser(JSON.parse(this._textSkin), currentBreakPoint));
    ...
    onBreakPointChange: function() {
      ...
      if(currentBreakPoint===640) {
        ...
        this.view.flxTabs.clipBounds = false;
        this.view.flxLeftDummy.width = "20dp";
        this.view.flxRightDummy.width = "20dp";
        this.view.flxSummaryDesktop.left = "20dp";
        this.view.flxSummaryDesktop.right = "20dp";
        this.view.flxBalanceDetailDesktop.left = "20dp";
        this.view.flxBalanceDetailDesktop.right = "20dp";
        this.view.flxTab3.left = "20dp";
        this.view.flxTab3.right = "20dp";
        this.view.flxTab4.left = "20dp";
        this.view.flxTab4.right = "20dp";
        this.view.flxTabs.left = "20dp";
        this.view.flxTabs.right = "20dp";
        this.view.flxDummy1.setVisibility(false);
        this.view.flxDummy2.setVisibility(false);
        this.view.flxDummy3.setVisibility(false);
        if(this.view.flx6Tab1.isVisible) {
     ...
     */
    setFormattedData: function(formatValues, text, type, fieldName) {
            ...
            if (formatValues.FieldValue.value.includes("\n") === true) {
                var scopeObj = this;
				if(fieldName === "Value3")
                this._hibaValue = formatValues.FieldValue.value;
			    if(fieldName === "Value4")
				this._profitValue = formatValues.FieldValue.value;
                this.view.FormatValue3Tab2.onTouchEnd = function() {
                    scopeObj.onSummaryLabelClick(scopeObj._hibaValue);
                };
				this.view.FormatValue4Tab2.onTouchEnd = function() {
                    scopeObj.onSummaryLabelClick(scopeObj._profitValue);
                };
                formatValues.FieldValue.value = "Click to view";
                formatValues.textSkin = "{\"skin\":\"sknSSP4176a415px\"}"
                formatValues.FieldType.type = "Label";
            }
            return formatValues;
        },
    ...
    bindAccountTypeStaticData: function() {
      ...
      if(this.view.btnTab2.isVisible) {
        ...
        var orientationHandler = new OrientationHandler();
        if (kony.application.getCurrentBreakpoint() == 640 || orientationHandler.isMobile) {
					if (this.accountType === "DepositIslamic" || this.accountType === "CheckingIslamic" || this.accountType === "SavingsIslamic") {
                        this.view.btnTab2.text = "Profits";
                    } else {
                        this.view.btnTab2.text = kony.i18n.getLocalizedString("i18n.accountDetail.interestsDetails");
                    }        
        } else {
                    if (this.accountType === "DepositIslamic" || this.accountType === "CheckingIslamic" || this.accountType === "SavingsIslamic") {
                        this.view.btnTab2.text = "Profit Details";
                    } else {
                        this.view.btnTab2.text = kony.i18n.getLocalizedString("i18n.accountDetail.interestDetails");
                    }
        }
    ...
    informationDismiss: function(){
        if(this.view.information.isVisible == true){
        this.view.information.setVisibility(false);
        }
      },
