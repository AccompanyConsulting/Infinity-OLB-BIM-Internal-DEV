...
define(['./AccountsDAO', './ParseUtilsManager', 'FormatValueUtils'], function(AccountsDAO, ParseUtilsManager, FormatValueUtils) {
    return {
        ...
        initGettersSetters: function() {
            ...
            defineGetter(this, 'linkLabelSkin', () => {
                return this._linkLabelSkin;
            });
            defineSetter(this, 'linkLabelSkin', value => {
                this._linkLabelSkin = value;
            });
        },
        ...
        bindData: function() {
            ...
            try {
                var formatValues = {
                    ...
                    "LINK_LABEL_SKIN": scope._linkLabelSkin,
                    "LINK_LABEL_ACTION": "onLinkClick",
