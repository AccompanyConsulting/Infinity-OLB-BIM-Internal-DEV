  ...
  return {
    ...
    preShow: function() {
      ...
      try {
        ...
        self.initActions();
        self.drawLinks();
        self.view["btnRowLink1"].onKeyPress = self.onKeyPressCallBack;
        self.view["btnRowLink" + self._numberOfLinks].onKeyPress = self.onKeyPressCallBack;
    ...
    onKeyPressCallBack: function(eventObject, eventPayload){
      var scope = this;
      if(kony.application.getCurrentForm().id!=="frmMortgageAccountDetails"){
      if (eventPayload.keyCode === 27) {
        eventPayload.preventDefault();
        scope.view.isVisible = false;
        scope._parentScope.view.imgSecondaryActions.src = "arrow_down.png";
        scope._parentScope.view.flxSecondaryActions.setActive(true);
        scope._parentScope.view.flxActions.zIndex = 1;
      }
      if (eventObject.id === "btnRowLink1"){
        ...
        if (eventPayload.keyCode === 9 && eventPayload.shiftKey === false){
          ...
          scope.view.isVisible = false;
          scope._parentScope.view.imgSecondaryActions.src = "arrow_down.png ";
          scope._parentScope.view.btnAll.setActive(true);
          scope._parentScope.view.flxActions.zIndex = 1;
        }
      }
    }
        ...
        for(var i = 1; i <= 10; i++) {
          ...
          if(link !== "") {
            ...
            self.view["btnRowLink" + i].accessibilityConfig = accessibility;
              ...
              self.view["btnRowLink" + i].accessibilityConfig={
                "a11yARIA":{
                  "tabindex":0
                }
              }
