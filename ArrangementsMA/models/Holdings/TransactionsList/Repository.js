define([], function(){
	...
	//For Operation 'searchTransactions' with service id 'searchTransactions1288'
	TransactionsListRepository.prototype.searchTransactions = function(params, onCompletion){
		return TransactionsListRepository.prototype.customVerb('searchTransactions', params, onCompletion);
	};
