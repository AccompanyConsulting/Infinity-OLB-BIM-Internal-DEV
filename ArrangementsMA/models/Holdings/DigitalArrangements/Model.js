...
define([], function() {
    ...
    var setterFunctions = {
        ...
        closingReason: function(val, state) {
            context["field"] = "closingReason";
            context["metadata"] = (objectMetadata ? objectMetadata["closingReason"] : null);
            state['closingReason'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        supportingDocumentData: function(val, state) {
            context["field"] = "supportingDocumentData";
            context["metadata"] = (objectMetadata ? objectMetadata["supportingDocumentData"] : null);
            state['supportingDocumentData'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        accountsCount: function(val, state) {
            context["field"] = "accountsCount";
            context["metadata"] = (objectMetadata ? objectMetadata["accountsCount"] : null);
            state['accountsCount'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        reDesignFlow: function(val, state) {
            context["field"] = "reDesignFlow";
            context["metadata"] = (objectMetadata ? objectMetadata["reDesignFlow"] : null);
            state['reDesignFlow'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        showUpgradePopup: function(val, state) {
            context["field"] = "showUpgradePopup";
            context["metadata"] = (objectMetadata ? objectMetadata["showUpgradePopup"] : null);
            state['showUpgradePopup'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function DigitalArrangements(defaultValues) {
        ...
        context["field"] = "closingReason";
        context["metadata"] = (objectMetadata ? objectMetadata["closingReason"] : null);
        privateState.closingReason = defaultValues ?
            (defaultValues["closingReason"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["closingReason"], context) :
                null) :
            null;

        context["field"] = "supportingDocumentData";
        context["metadata"] = (objectMetadata ? objectMetadata["supportingDocumentData"] : null);
        privateState.supportingDocumentData = defaultValues ?
            (defaultValues["supportingDocumentData"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supportingDocumentData"], context) :
                null) :
            null;

        context["field"] = "accountsCount";
        context["metadata"] = (objectMetadata ? objectMetadata["accountsCount"] : null);
        privateState.accountsCount = defaultValues ?
            (defaultValues["accountsCount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["accountsCount"], context) :
                null) :
            null;

        context["field"] = "reDesignFlow";
        context["metadata"] = (objectMetadata ? objectMetadata["reDesignFlow"] : null);
        privateState.reDesignFlow = defaultValues ?
            (defaultValues["reDesignFlow"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["reDesignFlow"], context) :
                null) :
            null;

        context["field"] = "showUpgradePopup";
        context["metadata"] = (objectMetadata ? objectMetadata["showUpgradePopup"] : null);
        privateState.showUpgradePopup = defaultValues ?
            (defaultValues["showUpgradePopup"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["showUpgradePopup"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "closingReason": {
                get: function() {
                    context["field"] = "closingReason";
                    context["metadata"] = (objectMetadata ? objectMetadata["closingReason"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.closingReason, context);
                },
                set: function(val) {
                    setterFunctions['closingReason'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "supportingDocumentData": {
                get: function() {
                    context["field"] = "supportingDocumentData";
                    context["metadata"] = (objectMetadata ? objectMetadata["supportingDocumentData"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.supportingDocumentData, context);
                },
                set: function(val) {
                    setterFunctions['supportingDocumentData'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "accountsCount": {
                get: function() {
                    context["field"] = "accountsCount";
                    context["metadata"] = (objectMetadata ? objectMetadata["accountsCount"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.accountsCount, context);
                },
                set: function(val) {
                    setterFunctions['accountsCount'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "reDesignFlow": {
                get: function() {
                    context["field"] = "reDesignFlow";
                    context["metadata"] = (objectMetadata ? objectMetadata["reDesignFlow"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.reDesignFlow, context);
                },
                set: function(val) {
                    setterFunctions['reDesignFlow'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "showUpgradePopup": {
                get: function() {
                    context["field"] = "showUpgradePopup";
                    context["metadata"] = (objectMetadata ? objectMetadata["showUpgradePopup"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.showUpgradePopup, context);
                },
                set: function(val) {
                    setterFunctions['showUpgradePopup'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.closingReason = value ? (value["closingReason"] ? value["closingReason"] : null) : null;
            privateState.supportingDocumentData = value ? (value["supportingDocumentData"] ? value["supportingDocumentData"] : null) : null;
            privateState.accountsCount = value ? (value["accountsCount"] ? value["accountsCount"] : null) : null;
            privateState.reDesignFlow = value ? (value["reDesignFlow"] ? value["reDesignFlow"] : null) : null;
            privateState.showUpgradePopup = value ? (value["showUpgradePopup"] ? value["showUpgradePopup"] : null) : null;
        };
    }
    ...
    //For Operation 'closeAccount' with service id 'closeAccountAck7336'
     DigitalArrangements.closeAccount = function(params, onCompletion){
        return DigitalArrangements.customVerb('closeAccount', params, onCompletion);
     };

    //For Operation 'submitAccountClosureServiceRequest' with service id 'SubmitAccountClosureServiceRequestOperation5683'
     DigitalArrangements.submitAccountClosureServiceRequest = function(params, onCompletion){
        return DigitalArrangements.customVerb('submitAccountClosureServiceRequest', params, onCompletion);
     };
    ...
    //For Operation 'getCoreCustomerIdsAndAccounts' with service id 'getCoreCustomerIdsAndAccounts5595'
     DigitalArrangements.getCoreCustomerIdsAndAccounts = function(params, onCompletion){
        return DigitalArrangements.customVerb('getCoreCustomerIdsAndAccounts', params, onCompletion);
     };
