        ...
        if (!this.isOriginationFlow) {
          if (applicationManager.getStorageManager().getStoredItem("langObj")) {
            ...
            if(langObj === "Arabic"){
             ...
             this.view.flxLoginComponentContainer.carousel.lblLeftArrow.text="Q";
            this.view.flxLoginComponentContainer.carousel.lblRightArrow.text="R";
            this.view.flxLoginComponentContainer.carousel.lblLeftArrow.centerX="0dp";
            this.view.flxLoginComponentContainer.carousel.lblLeftArrow.left="120dp";
        ...
        if (scopeObj.view.lblCheckBox.text === "O") {
          if (CommonUtilities.isMirrorLayoutEnabled()) {
            ...
            if (kony.application.getCurrentBreakpoint() > 1024) {
              ...
              scopeObj.view.flxLanguagePicker.right = scopeObj.view.flxDropdown.info.frame.x - 6 + "dp";
...
//         });
        ...
        scopeObj.view.flxImgInfoIcon.onClick = function () {
          if (!scopeObj.view.AllForms1.isVisible) {
            ...
            if (kony.application.getCurrentBreakpoint() > 1400) {
              ...
              scopeObj.view.AllForms1.RichTextInfo.text = kony.i18n.getLocalizedString("i18n.frmLogin.Information");
    ...
    //function to translate english numbers to arabic
        ArabicTranslate: function(a){
            const arabicNumerals = {
                0: '٠', 1: '١', 2: '٢', 3: '٣', 4: '٤', 5: '٥', 6: '٦', 7: '٧', 8: '٨', 9: '٩'
            };
            var arb =arabicNumerals[a];
            return arb;
        },
    setDefaultCampaignInfo: function() {
        ...
        if (self.view.carousel.segCarousel.data.length > 1) {
            ...
            //i18nchanged for "of" and added code for arabic
            if ( applicationManager.getStorageManager().getStoredItem("langObj") && applicationManager.getStorageManager().getStoredItem("langObj").language === "Arabic") {
                var ArNum=self.ArabicTranslate(data);
                self.view.carousel.lblInfo.text = "١ "+ kony.i18n.getLocalizedString("i18n.login.Campaign.of")+" "  +ArNum;
            }
            else
            self.view.carousel.lblInfo.text = "1 " + kony.i18n.getLocalizedString("i18n.login.Campaign.of") + " " + data;
    },
    ...
    onArrowClickCarousel: function(key) {
      ...
      self.view.carousel.segCarousel.setActive(currentCarouselRow, 0, "flxCampaignCarouselLogin.flxCampaignImg");
 //i18nchanged for "of",  added code for arabic lang representation.
            if (applicationManager.getStorageManager().getStoredItem("langObj").language === "Arabic") {
                var LastArNum=self.ArabicTranslate(segDataLength);
                var FirstArNum = self.ArabicTranslate(currentCarouselRow + 1);
                self.view.carousel.lblInfo.text = FirstArNum+" "+ kony.i18n.getLocalizedString("i18n.login.Campaign.of")+" "+LastArNum;
            }
            else
            self.view.carousel.lblInfo.text = (currentCarouselRow + 1) + " " + kony.i18n.getLocalizedString("i18n.login.Campaign.of") + " " + segDataLength;
  ...
  onKeyPressArrow: function(key, eventobject, eventPayload) {
    ...
    onSwipeCarouselCallBack: function(segUI, widget, currentRow) {
        ...
        self.view.carousel.segCarousel.setActive(currentCarouselRow, 0, "flxCampaignCarouselLogin.flxCampaignImg");
 //i18nchanged for "of" and added code for arabic lang representation
            if (applicationManager.getStorageManager().getStoredItem("langObj").language === "Arabic") {
                var LastArNum=self.ArabicTranslate(segDataLength);
                var FirstArNum = self.ArabicTranslate(currentCarouselRow + 1);
                self.view.carousel.lblInfo.text = FirstArNum+" "+ kony.i18n.getLocalizedString("i18n.login.Campaign.of")+" "+LastArNum;
      ...
      resetToLoginScreen: function (errorMessage) {
        ...
        if (locale === "ar_AE") {
          ...
          self.view.lblLanguage.right = "75dp";
