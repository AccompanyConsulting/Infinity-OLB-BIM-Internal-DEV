  ...
  return{
    ...
    frmLoginPostshow: function() {
      ...
      if(kony.theme.getCurrentTheme()==="darkTheme"){
        ...
        this.view.imgEnroll.src="supportdark.png";
        this.view.imgSupport.src="groupdark.png";
      }
      else{
        this.view.imgLocateUs.src="locateusfooter.png";
        this.view.imgEnroll.src="house.png";
        this.view.imgSupport.src="group.png";
      }
    ...
    onClickExploreProducts: function(){
     ...
     const navManager = applicationManager.getNavigationManager();
     navManager.navigateTo({ "appName": "AuthenticationMA", "friendlyName": "AuthUIModule/frmExploreProducts" });
    },
    onClickResumeApplication: function(){        
        const navManager = applicationManager.getNavigationManager();
        navManager.navigateTo({ "appName": "AuthenticationMA", "friendlyName": "AuthUIModule/frmResumeApplication" });
    },
    showNewLogin: function(){
      ...
      this.view.flxResumeApp.setVisibility(authMode.presentationController.isResumeApplicationShown);      
    },
...
//         });
    ...
    loginFunctionalPreshow: function() {      
      ...
      //EIBB-15813 - removing account preview.
      /*
    ...
    frmLoginPreShow:function(){
      ...
      if(authMode.presentationController.isTeePeeNavigationRequired){
		  if(applicationManager.gblDeepLink === "true"){			  
			this.view.flxGroup.setVisibility(false);
			this.view.flxAuthoriseConsent.setVisibility(true);			  
			this.view.flxFooter.setVisibility(false);
			this.view.flxBackgroundImage.setVisibility(false);
			this.view.flxWelcome.setVisibility(false);
			this.view.flxShadow.setVisibility(false);
			this.view.imgKonyLogo.setVisibility(false);		      
		  }else{
			...
			this.view.flxBackgroundImage.setVisibility(true);
			this.view.flxWelcome.setVisibility(true);
			this.view.flxShadow.setVisibility(true);
			this.view.imgKonyLogo.setVisibility(true);			  
		  }		  
	  }else{
		  if(applicationManager.gblDeepLink === "true"){		  
			  this.view.flxFooter.setVisibility(false);		      
	...
	/*  if(applicationManager.gblDeepLink === "true"){		
		...
		this.view.flxShadow.setVisibility(false);
		this.view.imgKonyLogo.setVisibility(false);
	//	this.view.rtxAuthConsentMsg.text = "Authorise <b>"+applicationManager.deeplinkAppName+"</b> to read your account information";
		//return;
	  }else{        
        this.view.flxBackgroundImage.setVisibility(true);
        this.view.flxWelcome.setVisibility(true);
      ...
      if(authMode.presentationController.isNewLogintobeShown && authMode.presentationController.isloginFormShown && this.view.login.isVisible){
      ...
      this.view.login.setVisibility(true);
      this.view.flxCampaignsWrapper.setVisibility(true);	  
	  this.view.flxLanguageSelection.setVisibility(true);
      const configManager = applicationManager.getConfigurationManager();
    ...
    setFlowActions: function(){
      ...
      scopeObj.view.btnAuthoriseContinue.onClick = scopeObj.onClickBtnAuthorise;
      scopeObj.view.customHeader.btnRight.onClick = scopeObj.onClickAuthoriseCancel;
    },
	...
	onClickAuthoriseCancel: function(){
		var scopeObj = this;
	...
	onClickBtnAuthorise : function(){
        ...
        this.view.flxFooter.setVisibility(false);
        this.view.flxCampaignsWrapper.setVisibility(false);
        this.view.flxLanguageSelection.setVisibility(false);
		this.view.imgKonyLogo.setVisibility(true);
		this.view.lblWelcomeMessage.text = "Welcome to Temenos Digital";
	},
