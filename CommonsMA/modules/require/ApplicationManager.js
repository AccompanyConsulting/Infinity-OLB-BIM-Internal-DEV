  ...
  */
  ...
  /**
   ...
   ApplicationManager.prototype.handleAppService = function(params) {
        ...
        var authTokenConsent = params.launchparams.authToken;
        this.deeplinkAppName = params.launchparams.tppName;
        this.consentTypeName = params.launchparams.accountConsentType;
        this.deeplinkSchemaName = params.launchparams.callbackDeeplinkSchema;
        if (authTokenConsent) {
            authMode.presentationController.validateAuthToken(authTokenConsent);
        }
    };
