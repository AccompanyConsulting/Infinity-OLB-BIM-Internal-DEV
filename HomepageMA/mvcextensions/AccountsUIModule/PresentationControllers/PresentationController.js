define(["CommonUtilities", "OLBConstants"], function(CommonUtilities, OLBConstants) {
    function PresentationController() {
		...
		this.isWealthUserMultiCustomer = false;
                this.isWealthPrimaryUser = false;
    }
...
//       this.loadAccountsLandingComponents();
    ...
    PresentationController.prototype.fetchWelcomeBannerSuccess = function(userData) {
	  ...
	  PresentationController.prototype.showCustomers = function(params) {
		...
		var enableCustomerDahboard = configManager.getEnableHeavyUserDasboard();
		if(enableCustomerDahboard === "true"){
     ...
     PresentationController.prototype.fetchCustomersSuccess = function(params, response) {
       ...
       if(response.reDesignFlow === "true" && !wealthInvestmentDetail ){
        ...
        applicationManager.getNavigationManager().updateForm({
            ...
            if(!kony.sdk.isNullOrUndefined(backendID) && !kony.sdk.isNullOrUndefined(coreCustomers)){
                var customerLength = coreCustomers.length;			  
			  // var primaryUser = applicationManager.getUserPreferencesManager().getUserObj().CoreCustomers[0].isPrimary
               var coreCustomerID = coreCustomers[0].coreCustomerID;
			   if(customerLength > 1 || ((backendID !== "" && backendID !== undefined && backendID !== null )  && (coreCustomerID !== backendID))){
    ...
    PresentationController.prototype.callPostAccountsService = function() {
        ...
        if (this.fetchOutageMessages) {
            ...
            scope.fetchOutageMessages = false;
        } else {
            scope.showOutageMessage();
        }
    };
    ...
    PresentationController.prototype.fetchCustomerAccounts = function(params) {
      ...
      //  this.customerId = params.Membership_id;
	   ...
	   PresentationController.prototype.getcustomerAccountsWithCustID = function(params) {
        ...
        applicationManager.getPresentationUtility().showLoadingScreen();
        this.showWelcomeBanner();
        this.fetchCustomerAccountsWithCustID(params);
        this.loadAccountsLandingComponents();
    };
	 
	  PresentationController.prototype.fetchCustomerAccountsWithCustID = function(params) {
        var self = this;
      //  this.customerId = params.Membership_id;
        function completionCallback(accountsData) {
            this.customeraccounts = accountsData;
        ...
        this.isAccountsLoading = true;
        applicationManager.getAccountManager().fetchInternalAccountBycustID(params, completionCallback.bind(this), this.showOnServerError.bind(this));
     };
