...
define(['OLBConstants'], function(OLBConstants) {
  ...
  function AccountManager() {
    ...
    this.openNewAccountActive=false;
 ...
 */
  ...
  */
   ...
   */
    AccountManager.prototype.fetchMessagesNotifications = function(presentationSuccess,presentationError) {
     ...
     AccountManager.prototype.openNewAccountAudit = function(presentationSuccessCallback, presentationErrorCallback) {
    var adhocStatements = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("Audit");
    adhocStatements.customVerb("openNewAccountAudit", {}, getAllCompletionCallback);
    function getAllCompletionCallback(status, data, error) {
        var srh = applicationManager.getServiceResponseHandler();
        var obj = srh.manageResponse(status, data, error);
        if (obj["status"] === true) {
 ...
 AccountManager.prototype.exitAccountOpeningAudit = function(presentationSuccessCallback, presentationErrorCallback) {
    var adhocStatements = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("Audit");
    adhocStatements.customVerb("ExitAccountOpeningAudit", {}, getAllCompletionCallback);
    function getAllCompletionCallback(status, data, error) {
        var srh = applicationManager.getServiceResponseHandler();
        var obj = srh.manageResponse(status, data, error);
        if (obj["status"] === true) {
  ...
  AccountManager.prototype.getPSD2Accounts = function(criteria, presentationSuccessCallback, presentationErrorCallback) {
        var consentINAU = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("ConsentsPSD2New");
        consentINAU.customVerb("getPSD2Accounts", criteria, getAllCompletionCallback);
        function getAllCompletionCallback(status, data, error) {
            var srh = applicationManager.getServiceResponseHandler();
            var obj = srh.manageResponse(status, data, error);
            if (obj["status"] === true) {
  ...
  AccountManager.prototype.approveConsent = function(criteria, presentationSuccessCallback, presentationErrorCallback) {
        var approveConsent = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("ConsentsPSD2New");
        approveConsent.customVerb("approveConsent", criteria, getAllCompletionCallback);
        function getAllCompletionCallback(status, data, error) {
            var srh = applicationManager.getServiceResponseHandler();
            var obj = srh.manageResponse(status, data, error);
            if (obj["status"] === true) {
  ...
  AccountManager.prototype.denyConsent = function(criteria, presentationSuccessCallback, presentationErrorCallback) {
        var approveConsent = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("ConsentsPSD2New");
        approveConsent.customVerb("denyConsent", criteria, getAllCompletionCallback);
        function getAllCompletionCallback(status, data, error) {
            var srh = applicationManager.getServiceResponseHandler();
            var obj = srh.manageResponse(status, data, error);
            if (obj["status"] === true) {
  ...
  AccountManager.prototype.denyConsentPreLogin = function(criteria, presentationSuccessCallback, presentationErrorCallback) {
        var approveConsent = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository("ConsentsPSD2New");
        approveConsent.customVerb("preloginCancelConsent", criteria, getAllCompletionCallback);
        function getAllCompletionCallback(status, data, error) {
            var srh = applicationManager.getServiceResponseHandler();
            var obj = srh.manageResponse(status, data, error);
            if (obj["status"] === true) {
