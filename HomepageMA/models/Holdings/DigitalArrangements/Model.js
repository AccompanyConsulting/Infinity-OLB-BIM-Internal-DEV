...
define([], function() {
    ...
    //For Operation 'getLatestBalances' with service id 'GetLatestBalances5926'
     DigitalArrangements.getLatestBalances = function(params, onCompletion){
        return DigitalArrangements.customVerb('getLatestBalances', params, onCompletion);
     };
