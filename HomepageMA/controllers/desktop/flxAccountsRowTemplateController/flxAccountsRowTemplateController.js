define(['FormControllerUtility'], function(FormControllerUtility) {
    return {
        ...
        menuPressed: function() {
            ...
            FormControllerUtility.updateWidgetsHeightInInfo(currForm, ['flxDowntimeWarning',
                'flxOverdraftWarning',
                'flxOutageWarning',
                'flxMainWrapper',
                'flxLeftContainer'
...
//               hidePopups();	
              ...
              if(popUpCount>0) currTop += 30 + (popUpCount-1)*26;
               ...
               if (currForm.flxAccountsHeader.isVisible === false) {
                ...
                var acctop = parseInt(currForm.flxSbaMainCashFlowGraph.height.split('dp')[0]) + 20;
                
                if (currBreakpoint ===1366 && orientationHandler.isDesktop) currTop -= (20*totalCount +20);
                currForm.accountListMenu.top = (currForm.flxSbaMainCashFlowGraph.isVisible ? acctop + currTop : currTop) + "dp";
              if (currBreakpoint ===1024 && orientationHandler.isTablet) currTop -= (20*totalCount +20);
                currForm.accountListMenu.top = (currForm.flxSbaMainCashFlowGraph.isVisible ? acctop + currTop : currTop) + 70 + "dp";
