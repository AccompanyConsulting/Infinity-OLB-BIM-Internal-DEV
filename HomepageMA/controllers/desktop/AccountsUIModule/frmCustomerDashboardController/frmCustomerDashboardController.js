define(['FormControllerUtility', 'ViewConstants', 'CommonUtilities', 'OLBConstants', 'CampaignUtility'], function(FormControllerUtility, ViewConstants, CommonUtilities, OLBConstants, CampaignUtility) {
    ...
    return {
        ...
        isWealthUserMultiCustomer:false,
        customerList:[],
        favCustomerList:[],
        selectedCustomerId:"",
        currentFilter:"",
        updateFormUI: function(uiData) {
            if (uiData) {
                ...
                if (uiData.accountsSummary) {
                    ...
                    if(!this.isWealthUserMultiCustomer){
        ...
        initActions: function() {
           ...
           // this.view.flxChart.onClick = this.showChart;
            ...
            this.view.flxMain.onClick = this.closeDropdown;
            this.view.flxFormContent.onClick = this.closeDropdown;
        },
        //Method to close the customer dropdown while clicking out of the dropdown  
        ...
        */
        ...
        // },
            ...
            setErrorMessage: function(response){
                this.view.flxRightContainer.isVisible = false;
                this.view.flxLeftContainer.width = '88%';
                this.view.flxLeftContainer.left = "6%";
               // this.view.flxMyCashPosition.isVisible = false;
                this.view.flxCustomerContainerHeader.isVisible = true;
                this.view.flxCustomerSearch.width = "70%";
                this.view.flxFilter.width = "25%";
                this.view.flxFilter.left = "73%";
                this.view.lblFilterText.width = "70%";
                this.view.lblFilterText.left = "4px";
                this.view.lblFilterText.centerX = "";
                this.view.txtCustomerSearch.centerY = "";
                this.view.txtCustomerSearch.height = "40px";
				this.view.SegCustomers.setVisibility(false);
                this.view.flxNodata.isVisible = true;
		},
        // hide other cards and set only customer overview card
        setWealthCustomerOverview:function(response){
            try{
            this.isWealthUserMultiCustomer = true;
            this.view.flxRightContainer.isVisible = false;
            this.view.flxLeftContainer.width = '88%';
            this.view.flxLeftContainer.left = "6%";
           // this.view.flxMyCashPosition.isVisible = false;
			...
			this.view.txtCustomerSearch.centerY = "";
			this.view.txtCustomerSearch.height = "40px";
            this.view.txtCustomerSearch.text ="";
            this.view.flxCustomerClearBtn.setVisibility(false);
            this.view.flxNodata.isVisible = false;
            this.view.SegDropDown.isVisible = false;
            this.view.lblCustDropDown.text = 'O';
            this.view.flxCustomerClearBtn.setVisibility(false);
			var customers = response ? response.Customers :"";
                this.customerList = customers;
                if (this.currentFilter !== "") {
                    this.view.lblFilterText.left = this.currentFilter === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers") ? "4px" : "24px";

                    this.view.lblFilterText.text = this.currentFilter;
                }
            this.setWealthCustomerData(customers);
            this.initializeSearchAndFilterActions(customers);
            }catch(error){
           console.log(error);
        }
        },

    // setting wealth customer data to the segment
        setWealthCustomerData: function(customerDetails){
            try{
            var scope = this;
            let paginationCount = applicationManager.getConfigurationManager().getConfigurationValue('wealthCustomersPerPage');
            ...
            //this.view.SegCustomers.rowTemplate = 
            this.view.SegCustomers.rowTemplate = "flxCustomerList";
            var dataMap = {
                "lblCustomerName": "lblCustomerName",
                "lblCustomerIDValue": "lblCustomerIDValue",
                "lblTotalAssetValue": "lblTotalAssetValue",
                "lblTotalAssetTitle":"lblTotalAssetTitle",
            ...
            if(this.currentFilter === kony.i18n.getLocalizedString("i18n.wealth.FavCustomers")){
                 customerDetails =  customerDetails.filter(e => e.isFavourite === "true");
            }   
            if (customerDetails !== undefined && customerDetails.length > 0) {
                    var data = customerDetails.map(function(res, idx, array) {
                        var forUtility = applicationManager.getFormatUtilManager();
                        var totalAssetValue = forUtility.formatAmountandAppendCurrencySymbol(res.totalAssetValue, res.currencyCode);
                        var assetVal = totalAssetValue ? totalAssetValue.split('.') : "";
                        return {
                            "customerId":{
                            ...
                            "lblCustomerIDValue": {
                                "text": kony.i18n.getLocalizedString("i18n.wealth.customerID") + res.customerId
                            },
                            "lblTotalAssetValue": {
                                "text": assetVal[0]
                            },
                            "lblTotalAssetTitle":{
                                "text":kony.i18n.getLocalizedString("i18n.wealth.TotalAssetValue")
                            },
                            "imgStarIcon": {
                                "text": res.isFavourite === "true" ? "F" : "k",
                                "onTouchEnd":function(e){
                                scope.onClickFavoriteImg(e)
                                }.bind(this)
                            },
                            "flxContent": {
                                "onClick": function(eventObject, segInfo, xcoord, context) {
                                    scope.wealthCustomerRowOnClick(eventObject,segInfo);
                                }.bind(this)
                            },
                            "flxSeparator": {
                                "isVisible": !(idx === array.length - 1 || (idx + 1) % paginationCount === 0)
                            }
                        }
                    });
                this.setPagination({
                ...
                let segmentData = data.slice(this.offset, this.lastRecord)
                this.view.flxAccountsSegment.height = segmentData.length < 6 ? '410px' : `${(segmentData.length * 80) + 10}px`;
                this.view.SegCustomers.setData(segmentData);
                this.view.SegCustomers.isVisible=true;
                this.view.flxNodata.isVisible=false;
				var length = applicationManager.getUserPreferencesManager().getUserObj().CoreCustomers.length;
                this.view.lblCustomers.text = `${kony.i18n.getLocalizedString("konybb.userMgmt.Customers")} (${length})`;
                this.AdjustScreen();
            }
            else {
                const accessibilityConfig = CommonUtilities.getaccessibilityConfig();
                CommonUtilities.setText(this.view.lblDowntimeWarning, kony.i18n.getLocalizedString("i18n.Wealth.unableToRetrieveList"), accessibilityConfig);
                this.view.lblDowntimeWarning.setFocus(true);
                this.view.flxDowntimeWarning.setVisibility(true);
                this.view.flxDownTimeClose.right = '20px'
                this.view.flxDownTimeClose.centerY = '50%'
                this.view.imgDowntimeWarning.src = 'info.png'
                this.view.imgDowntimeWarning.height = '32px' 
                this.view.imgDowntimeWarning.width = '32px'
                this.view.imgDowntimeWarning.left = '20px'
                this.view.lblDowntimeWarning.left = '60px'
                this.view.flxAccountsSegment.height = '400px'
                this.view.PaginationContainer.setVisibility(false);
                this.view.flxPaginationSeparator.setVisibility(false);
                this.view.lblCustomers.text = `${kony.i18n.getLocalizedString("konybb.userMgmt.Customers")} (0)`;
        ...
        onClickFavoriteImg: function (e) {
            try {
                applicationManager.getPresentationUtility().showLoadingScreen();
                var parentData = e.parent.parent.flxCustomerID.lblCustomerIDValue.text;
                var customerId = parentData.split(':')[1];
                this.selectedCustomerId = customerId.toString();
                var operation = e.text === "F" ? "Remove" : "Add";
                this.updateFavoriteCustomer(this.selectedCustomerId, operation);
            } catch (err) {
                console.log(err);
            }
        },

        // service call to update favorite customer wealth
        updateFavoriteCustomer: function (customerId, operation) {
            try {
                var param = {
                    "operation": operation,
                ...
                wealthModule.updateFavoriteCustomer(param);
            } catch (e) {
                console.log(e);
            }
        },

       setWealthFavoriteCustomer: function(response) {
            try {
                let paginationCount = applicationManager.getConfigurationManager().getConfigurationValue('wealthCustomersPerPage');
                if (paginationCount === undefined || paginationCount === null) {
                    paginationCount = 10
                ...
                if (response && response.status === "Success") {
                    var index = this.customerList.findIndex(obj => obj.customerId === this.selectedCustomerId);
                    if (this.customerList[index].isFavourite === "true") {
                        this.customerList[index].isFavourite = "false";
                    } else {
                        this.customerList[index].isFavourite = "true";
                    }
                    if (this.view.lblFilterText.text === kony.i18n.getLocalizedString("i18n.wealth.FavCustomers")) {
						let favList=[]
						for(let i=0 ;i<this.customerList.length;i++){
							if(this.customerList[i].isFavourite == "true"){
								favList.push(this.customerList[i])
							}
						}
						if(favList.length>0){
						this.view.SegCustomers.setVisibility(true);
						this.view.flxNodata.isVisible = false;
						this.view.flxCustomerSearch.enable = true;
                        this.offset = (favList.length >= paginationCount) && (favList.length % paginationCount === 0) ? favList.length - paginationCount : this.offset;
                        this.setWealthCustomerData(favList);
						
						}else{
							this.view.SegCustomers.setVisibility(false);
							this.view.flxCustomerSearch.enable = false;
							this.view.lblNoData.text = kony.i18n.getLocalizedString("i18n.homepage.noFavourites");
							this.view.flxNodata.isVisible = true;
						}
                    } else {
                        this.view.txtCustomerSearch.text = "";
						this.view.flxCustomerClearBtn.setVisibility(false);
                        this.setWealthCustomerData(this.customerList);
                    }
                } else {
                    this.setWealthCustomerData(this.customerList);
     ...
     // Wealth customer onrow click event
        wealthCustomerRowOnClick: function(eventObject,segInfo){
            try{
            var customerDetail = {
                "customerName" : segInfo.widgetInfo.selectedRowItems[0].lblCustomerName.text,
                "customerId" : segInfo.widgetInfo.selectedRowItems[0].customerId.customerId
            }
             var navManager = applicationManager.getNavigationManager();
             navManager.setCustomInfo("frmCustomerDashboard", customerDetail);
            var params = {
                Membership_id: customerDetail.customerId
            };
            ...
            accountsModule.presentationController.customerIdName = customerDetail.customerName;
            accountsModule.presentationController.getcustomerAccountsWithCustID(params);
        ...
        preShowFrmAccountsLanding: function() {
            ...
            let wealthInvestmentDetail = applicationManager.getConfigurationManager().checkUserFeature("WEALTH_INVESTMENT_DETAILS");			
			let wealthPortfolioDetail = applicationManager.getConfigurationManager().checkUserFeature("WEALTH_PORTFOLIO_DETAILS");
		   if(wealthInvestmentDetail || wealthPortfolioDetail){
			   this.getCustomers();
		   }
            ...
            FormControllerUtility.updateWidgetsHeightInInfo(this.view, ['flxHeader', 'flxMain', 'flxFooter', 'flxAccountListAndBanner', 'flxFilterListBox', 'customheader', 'accountListMenu', 'flxDowntimeWarning', 'flxOverdraftWarning', 'flxOutageWarning', 'flxMainWrapper', 'flxLeftContainer', 'flxFormContent', 'flxApprovalAndRequest']);
        ...
        postShow: function() {
          ...
          /*   this.view.btnConfirm.accessibilityConfig = {
           ...
           /* this.view.calendarWidget.flxCancel.accessibilityConfig = {
            ...
            this.view.PaginationContainer.setPageSize(3);
            this.view.lblView.text = kony.i18n.getLocalizedString("i18n.common.View");
            this.view.lblFilterText.text = kony.i18n.getLocalizedString("i18n.wealth.AllCustomers");
            var scope = this;
            var segData = [];
            segData[0] = {
                "flxAccountTypes": {
        ...
        */
        ...
        setDropdowndataForWealth: function(e) {
            try {
                var segData = [];
                var hoverSkin = "sknsegf7f7f7hover";
                var defaultSkin = "slFbox";
                var selectedText = "";
                if (e.lblUsers) {
                    selectedText = e.lblUsers.text;
                } else {
                    selectedText = e.lblFilterText.text;
                }
                if (selectedText === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers")) {
                    segData[0] = {
                        "flxAccountTypes": {
                            "onKeyPress": scope.onsegKeyPressCallBack,
                            "skin": hoverSkin,
                            "onHover": scope.onDropdownHover
                        },
                        "lblUsers": kony.i18n.getLocalizedString("i18n.wealth.AllCustomers"),
                        "lblSeparator": "",
                    };
                    segData[1] = {
                        "flxAccountTypes": {
                        ...
                        "lblUsers": kony.i18n.getLocalizedString("i18n.wealth.FavCustomers"),
                        "lblSeparator": "",
                    };
                } else {
                    segData[0] = {
        ...
        onDropdownHover: function(e) {
            console.log(e)
            this.setDropdowndataForWealth(e);
        },
        onClickDropDown: function(e) {
            if(this.isWealthUserMultiCustomer){
                this.view.lblCustDropDown.text === 'O' ? 'P' : 'O';
                this.view.SegDropDown.skin = "sknFlxffffffShadowdddcdc3pxradius";
                this.view.SegDropDown.rowSkin = "slFbox";
        ...
        selectFilterOption: function(accounts) {
            ...
            if (selectedfilter === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers")) {
                this.view.SegDropDown.isVisible = false;
                this.view.lblCustDropDown.text = 'O';
                ...
                if (this.isWealthUserMultiCustomer) {
                    this.view.lblFilterText.left = "4px";
                     this.view.flxNodata.isVisible = false;
                     this.view.SegCustomers.setVisibility(true);
                    this.setWealthCustomerData(accounts);
                } else {
                ...
                if (this.isWealthUserMultiCustomer) {
                    this.view.lblFilterText.left = "24px";
                    for (var index = 0; index < accounts.length; index++) {
                        if (accounts[index].isFavourite === "true") {
                            recipientData.push(accounts[index]);
                        }
                    }
                    this.favCustomerList = recipientData;
                    this.view.SegDropDown.isVisible = false;
                    this.view.lblCustDropDown.text = 'O';
                    this.view.lblFilterText.text = selectedfilter;
                    if(recipientData.length > 0){
                        this.view.SegCustomers.setVisibility(true);
                        this.setWealthCustomerData(recipientData);
                    }else{
                        this.view.SegCustomers.setVisibility(false);
                        this.view.flxCustomerSearch.enable = false;
                        this.view.lblNoData.text = kony.i18n.getLocalizedString("i18n.homepage.noFavourites");
        ...
        showOrHideFilter: function() {
            ...
            if (scopeObj.view.lblDropDown.text === ViewConstants.FONT_ICONS.CHEVRON_DOWN) {
                ...
                var warningsList = [scopeObj.view.flxOutageWarning, scopeObj.view.flxOverdraftWarning, scopeObj.view.flxDowntimeWarning, scopeObj.view.flxDeviceRegistrationWarning, scopeObj.view.flxPriorityMessage];
                var count = 0;
        ...
        onTxtSearchKeyUp: function(accounts) {
           ...
           if(this.isWealthUserMultiCustomer){
               ...
               if (searchKeyword.length > 0) {
                ...
                var selectedfilter = this.view.lblFilterText.text;
                if (selectedfilter === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers")) {
                    var newdata = scopeObj.multipleCommonSegmentSearch(["customerName", "customerId"], searchKeyword, this.customerList)
                } else {
                    var newdata = scopeObj.multipleCommonSegmentSearch(["customerName", "customerId"], searchKeyword, this.favCustomerList)
                }
                if(newdata.length>0){
                    this.view.SegCustomers.setVisibility(true);
                    this.view.flxNodata.isVisible = false;
                    scopeObj.setWealthCustomerData(newdata);
                    this.onFirst({
                        'show': true,
                        'offset': 0
                    }, newdata)
                    ...
                    this.view.SegCustomers.setVisibility(false);
                    this.view.lblNoData.text = kony.i18n.getLocalizedString("i18n.homepage.noSearch");
                    this.view.flxNodata.isVisible = true;
                }
                scopeObj.view.forceLayout();
                scopeObj.AdjustScreen();
                ...
                if (selectedfilter === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers")) {
                    ...
                    scopeObj.setWealthCustomerData(this.favCustomerList);
                }
                scopeObj.view.forceLayout();
                scopeObj.AdjustScreen();
            }
        ...
        onSearchClearBtnClick: function(accounts) {
            ...
            //  scopeObj.view.SegCustomers.setData(data);
            if(this.isWealthUserMultiCustomer){
                this.view.lblFilterText.text = this.currentFilter ? this.currentFilter:kony.i18n.getLocalizedString("i18n.wealth.AllCustomers") ;
				//this.view.lblFilterText.text = kony.i18n.getLocalizedString("i18n.wealth.AllCustomers");
			}
            var selectedfilter = this.view.lblFilterText.text;
            if (selectedfilter === kony.i18n.getLocalizedString("i18n.wealth.AllCustomers")) {
...
*/
        ...
        setPasswordResetNotification: function () {
            var scopeObj = this;
            var acctop = scopeObj.view.accountListMenu.frame.y + 6;
            //scopeObj.view.accountListMenu.top = acctop + "dp";
            scopeObj.AdjustScreen();
	    ...
	    this.isWealthUserMultiCustomer = true;
            ...
            const coreCustomerIDs = coreCustomers.map(item => item.coreCustomerID);
            const commaSeparatedIDs = coreCustomerIDs.join(',');
            customerIds = commaSeparatedIDs;
            var param = {
				"coreCustomerId" : customerIds
			}
             var wealthModule = applicationManager.getModulesPresentationController({
                "moduleName": "WealthPortfolioUIModule",
                "appName": "PortfolioManagementMA"
            });
            wealthModule.getCustomers(param);
        },
        ...
        setPagination: function(values, viewModel) {
           ...
           if(this.isWealthUserMultiCustomer){
             paginationCount = applicationManager.getConfigurationManager().getConfigurationValue('wealthCustomersPerPage');
                if (paginationCount === undefined || paginationCount === null) {
                    paginationCount = 10 
                }
                // this.view.PaginationContainer.lblPagination.width = '35%'
            if (paginationCount >= recipientDetails || paginationCount === 0) {
                this.view.PaginationContainer.setVisibility(false);
                this.view.flxPaginationSeparator.setVisibility(false);
            } else {
                this.view.PaginationContainer.setVisibility(true);
                this.view.flxPaginationSeparator.setVisibility(true);
            }
           }else{
            ...
            this.view.PaginationContainer.lblPagination.text = this.isWealthUserMultiCustomer ? `${Math.floor(values.offset / paginationCount) + 1} ${kony.i18n.getLocalizedString("i18n.konybb.Common.of")} ${Math.ceil(recipientDetails/paginationCount)} ${kony.i18n.getLocalizedString("i18n.konybb.Common.Pages")}` : ((values.offset + 1) + " - " + lastRecord + " Customers");
        ...
        onFirst: function(values, viewModel) {
            var recipientDetails = viewModel.length;
            var paginationCount = this.isWealthUserMultiCustomer ? applicationManager.getConfigurationManager().getConfigurationValue('wealthCustomersPerPage') : applicationManager.getConfigurationManager().getConfigurationValue('customersPerPage');
            if (values.offset < recipientDetails) {
                values.offset = 0;
                this.offset = values.offset;
            }
            if (this.isWealthUserMultiCustomer) this.setWealthCustomerData(viewModel, values);
            else this.setCustomerData(viewModel, values);
        },
        ...
        onLast: function(values, viewModel) {
            ...
            if (values.offset < recipientDetails) {
                ...
                this.offset = this.isWealthUserMultiCustomer && (values.offset >= recipientDetails) ? values.offset - paginationCount : values.offset;
            }
            if (this.isWealthUserMultiCustomer) this.setWealthCustomerData(viewModel, values);
            else this.setCustomerData(viewModel, values);
        },
