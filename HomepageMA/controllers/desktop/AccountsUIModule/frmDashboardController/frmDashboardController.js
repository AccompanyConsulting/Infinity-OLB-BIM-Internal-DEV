    ...
    return {
        ...
        initActions: function() {
          ...
          //  this.chartDefaultValue = this.view.investmentLineChart.currentFilter;
            ...
            this.view.flxCustomerListback.onClick = () => applicationManager.getNavigationManager().navigateTo({appName:'HomepageMA', friendlyName:'frmCustomerDashboard'});
        },
        ...
        preShow: function() {
            ...
            this.view.lblValueMarketValue.text = "";
            ...
            this.view.upcomingTransactionsCombined.lblHeader.skin = "sknSSPSB42424218Px";
        ...
        preShowFrmAccountsLanding: function() {
            ...
            this.view.mySpending.lblHeader.skin = "sknSSPSB42424218Px";
        ...
        postShow: function() {
            ...
            this.view.flxCustomerListback.top = '22dp';
			...
			var isWealthUserMultiCustomer = accountsModule.presentationController.isWealthUserMultiCustomer;
            var isWealthPrimaryUser = accountsModule.presentationController.isWealthPrimaryUser;
            ...
            if (custDashboard === "true") {
                ...
                this.view.flxCustomerListback.isVisible = true;
                this.view.lblOverviewback.text = kony.i18n.getLocalizedString("i18n.Wealth.backToOverview");
                }else{
                this.view.flxCustomerListback.isVisible = false;                
                }

                if(isWealthPrimaryUser){
                     this.view.lblDashboardHeading.text = kony.i18n.getLocalizedString("i18n.Dashboard.AccountsOverview");
                }
         ...
         //   this.view.customheader.flxImgKony.left = '0px';
        },
        ...
        postShowWealthComp: function() {
            ...
            if (this.view.recentActivityComp.isVisible === false) {
               ...
               this.view.flxRecentActivityAndMarketing.isVisible = this.view.flxBannerContainerDesktop.isVisible ? true : false;
            }else{
            ...
            this.view.flxnewsAndWatch.top = "20dp"
            }
        },
        ...
        */
        ...
        initializeSearchAndFilterActions: function(accounts) {
            if (this.presenter.presentationController.customerdashboard === "true" || this.presenter.presentationController.isWealthUserMultiCustomer) {
            ...
            this.view.btnAdvancedFiltersDropdown.onClick = function() {
                ...
                var warningsList = [this.view.flxOutageWarning, this.view.flxOverdraftWarning, this.view.flxDowntimeWarning, this.view.flxDeviceRegistrationWarning, this.view.flxPriorityMessage];
                var count = 0;
        ...
        onFilterSelection: function() {
            ...
            this.selectedRowItem = this.view.accountsFilter.segDefaultFilters.selectedRowItems[0].accountType;
            if (this.presenter.presentationController.customerdashboard === "true" || this.presenter.presentationController.isWealthUserMultiCustomer) {
            ...
            for (var i = 0; i < segData.length; i++) {
                if (i === rowIndex) {
                    ...
                    if (kony.i18n.getCurrentLocale() === 'en' || kony.i18n.getCurrentLocale() === 'en_GB' || kony.i18n.getCurrentLocale() === 'en_US') {
                        scopeObj.view.lblSelectedFilter.text = segData[i].lblFilterValue.text.replace("View ", "");
                    } else if (kony.i18n.getCurrentLocale() === 'es_ES') {
                        scopeObj.view.lblSelectedFilter.text = segData[i].lblFilterValue.text.replace("Ver ", "");
                    } else if (kony.i18n.getCurrentLocale() === 'fr_FR') {
                        scopeObj.view.lblSelectedFilter.text = segData[i].lblFilterValue.text.replace("Vue ", "");
                    } else if (kony.i18n.getCurrentLocale() === 'de_DE') {
                        scopeObj.view.lblSelectedFilter.text = segData[i].lblFilterValue.text.replace("Aussicht ", "");
                    }
                    this.currentView = scopeObj.view.lblSelectedFilter.text;
                    //Since Dropdown should have "all acocunts" but selected filter label should have "All Accounts"
		...
		//	accounts.forEach(function(account) {
				if (currencies.length !== 0) accounts = accounts.filter(function(item) {
					if (data.currencies.includes(item.currency) || 
                    data.currencies.includes(item.currencyCode)) return true;
					else return false;
				});
        ...
        applyAdvancedFilterSelection: function(accounts) {
            ...
            if (this.view.advancedFilters.lblIconAccountName.text === "M") {
                ...
                this.flxByAccountsAccessibility();
            } else if (this.view.advancedFilters.lblIconBalance.text === "M" && this.view.advancedFilters.lblAccounts.text === kony.i18n.getLocalizedString("i18n.transfers.accountType")) {
                //         this.sortByAccountName();
                data.sortBy = "accountName";
                this.flxByAccountsAccessibility();
                this.flxByBalanceAccessibilty();
            } else if (this.view.advancedFilters.lblIconChoice3.text === "M" && this.view.advancedFilters.lblChoice3.text === kony.i18n.getLocalizedString("i18n.AccountsDetails.Balance")) {
                //         this.sortByBalance();
            ...
            if (this.lastFilterCriteria) {
                ...
                if (this.accountTypes.length > 1 && this.lastFilterCriteria.accountTypes) {
                    ...
                    if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                        ...
                        segData[0][0]["imgCheckbox"]["text"] = (indicator1 == true) ? 'C' : 'D';
                    }
                    this.view.advancedFilters.segTypeOfAccounts.setData(segData);
                }
...
//             }
        ...
        isPersonalAccount: function (account) {
            return this.primaryCustomerId.id === account.Membership_id && this.primaryCustomerId.type === 'personal' && account.isBusinessAccount === 'false';
        },
        /*
        ...
        cifFilter: function(account) {
            ...
            //Defect: ARB-33686 - Starts
            if ((account.accountType && account.displayName) && kony.i18n.getLocalizedString("i18n.Accounts.display"+account.accountType) === this.selectedRowItem) {
                return account.accountType && (kony.i18n.getLocalizedString("i18n.Accounts.display"+account.accountType) === this.selectedRowItem || ((account.displayName + " Accounts") === this.view.lblSelectedFilter.text));
            } else if (account.accountName && account.displayName === "Mortgage Facility" && this.view.lblSelectedFilter.text === "Mortgage Facilities") {
                return true;
...
*/
        ...
        getQuickActions: function(dataInput) {
            ...
            var quickActions = [{
                    ...
                    appName: [applicationManager.getConfigurationManager().microappConstants.UNIFIEDTRANSFER],
                    action: function(account) {
                        var data = {
                            "accounts": account,
                            "transferType": "Same Bank",
                            "transferFlow": "PayBeneficiary",
                            "loanContext": "Loan Due"
                        };
        ...
        getQuickActionsViewModel: function(account, actions) {
            ...
            if (account.accountType) {
                if (actions.length) {
                    ...
                    if (!applicationManager.getConfigurationManager().checkUserPermission("PAY_DUE_CREATE") && !applicationManager.getConfigurationManager().checkUserPermission("PAY_OTHER_CREATE")){
                        validActions = validActions.filter(e => e !== 'Pay Due Amount');
                    }
            ...
            accounts.forEach(function(account) {
                ...
                if (finalData.hasOwnProperty(accountType)) {
                    ...
                    for (i = 0; i < paginationrecords.length; i++) {					 
                  	...
                  	var leftValue = (kony.application.getCurrentBreakpoint() == 640) ? "38%" : "18%";
                    finalData[accountType] = [{
                            lblAccountTypeHeader: {
                                ...
                                "left": (kony.application.getCurrentBreakpoint() == 640) ? "0px" : "5px"
                            },
                            lblAccountRoleType: {
                                "isVisible": false
                            },
                            ...
                            lblTotalAccountText: {
                                "isVisible": true,
                                "text": kony.i18n.getLocalizedString("i18n.konybb.accountsLanding.TotalAccounts"),
                                "left": (kony.application.getCurrentBreakpoint() == 640) ? "0%": "1%"
                            },
                            lblAccountTypeCount: {
                              	"left": leftValue,
                                "isVisible": true,
                                "text": accountcount.toString().padStart(2, "0")
                            },
                            lblTotalAccBalance: {
                                "isVisible": true,
                            ...
                            flxHeaderName: {
                                "left": (kony.application.getCurrentBreakpoint() == 640) ? "10dp" : "12dp"
                            },
                            membershipId: account.Membership_id
                        },
                        [scopeObj.createAllAccountSegmentsModel(account, accounts.length)]
        ...
        getPFMMonthlyDonutChart: function(PFMData) {
            ...
            if (this.profileAccess === "both") {
                ...
                this.view.mySpending.lblHeader.left = "20dp";
                if (kony.application.getCurrentBreakpoint() === 640 || orientationHandler.isMobile) {
                    this.view.mySpending.width = "93%";
                    this.view.mySpending.left = "2%";
        ...
        onBreakpointChange: function(width) {
            var accountsData = this.view.accountList.segAccounts.data;
            ...
            if (accountsData.length > 0) {
                accountsData.forEach(data => {
                    if (data[0].hasOwnProperty("lblAccountTypeCount")) {
                        data[0].lblAccountTypeCount.left = (kony.application.getCurrentBreakpoint() == 640) ? "38%" : "18%";
                    }
                });
                this.view.accountList.segAccounts.setData(accountsData);
            }
            ...
            var isWealthUserMultiCustomer = accountsModule.presentationController.isWealthUserMultiCustomer;
                ...
                if (kony.application.getCurrentBreakpoint() >= 1366) this.view.flxCustomerListback.top = '22dp'
                this.view.flxMainChartCon.flxCashPostionChart.height = "200dp";
                this.view.flxMainChartCon.height = "200dp";
        ...
        getAssetsList: function() {
            ...
            var params = {
                "coreCustomerId": isWealthUserMultiCustomer ? scope_WealthPresentationController.selectedCustomerID : ""
            };
            if (applicationManager.getConfigurationManager().isMicroAppPresent("PortfolioManagementMA")) {
        ...
        lineChartData: function(responseObj) {
            ...
            if (val.graphDuration && val.graphDuration.length > 0) {
                ...
                this.view.flxSeparator3.isVisible = true;
      ...
      onPerformanceFilterChange: function(filter) {
        ...
        goToPortfolioDetails: async function(dataObject) {
            ...
            await this.getPortfolioPermission(dataObject.portfolioId);
        ...
        // handling the getPortfolioPermissions service call using Promise as we require the Permissions before navigating to frmPortfolioOverview
        getPortfolioPermission: function(id) {
            let param = {
                "portfolioId": id
            }
            applicationManager.getPresentationUtility().showLoadingScreen();
            const WealthPortfolioManager = applicationManager.getWealthPortfolioManager();
            return new Promise((resolve, reject) => {
                WealthPortfolioManager.getPortfolioPermissions(param, succesCallback.bind(this), function (res) {
                    console.log('Error in fetching Portfolio Permissions')
                    applicationManager.getPresentationUtility().dismissLoadingScreen();
                    resolve();
                });
                function succesCallback(response) {
                    applicationManager.getPresentationUtility().dismissLoadingScreen();
                    scope_WealthPresentationController.portfolioPermissions = response["permissions"];
                    resolve();
                }
            })
        },
        ...
        setCustomerData: function() {
            try {
                var navManager = applicationManager.getNavigationManager();
               var customerData = navManager.getCustomInfo("frmCustomerDashboard");
			   scope_WealthPresentationController.selectedCustomerID = customerData.customerId;
            // const {coreCustomerName, coreCustomerID} = applicationManager.getUserPreferencesManager().getUserObj().CoreCustomers[0];
            // const customerName = coreCustomerName.split(' ').map(word => word[0].toUpperCase() + word.slice(1).toLowerCase()).join(' ');
            this.view.lblDashboardHeading.text = `${customerData.customerName} (${customerData.customerId})`;
            }
            catch(e) {
                var errorObj = {
            ...
            this.view.flxMarketNewsContainer.top = '0px';
            this.view.flxCustomerListback.isVisible = true;


            this.view.lblOverviewback.text = kony.i18n.getLocalizedString("i18n.Wealth.backToOverview")
            this.view.lblDashboardHeading.top = '52dp';
            this.view.flxMainWrapper.top = '92dp';
            this.view.flxMarketNewsContainer.top = '0px';
            this.view.lblDashboardHeading.skin = 'sknLabel42424224pxSemiBold'
            this.view.lblOverviewback.skin = 'sknLblSSP004BB115Px'
            this.view.flxCustomerListback.width = '30%'




            this.view.imgCustListBack.src = 'arrow_left.png'
            this.view.imgCustListBack.width = '20px'
            this.view.imgCustListBack.height = '20px'
            this.view.imgCustListBack.top = '0px'
            this.view.imgCustListBack.imageScaleMode = constants.IMAGE_SCALE_MODE_FIT_TO_DIMENSIONS
        },
        ...
        getWealthModules: function() {       
            ...
            let dateFlag = scope_configManager.wealthBankDate
            if (dateFlag === undefined || dateFlag === null || dateFlag === '') {
                dateFlag = true
            }
            var isWealthUserMultiCustomer = accountsModule.presentationController.isWealthUserMultiCustomer;
			if(isWealthUserMultiCustomer){
            ...
            if (dateFlag.toString().toLowerCase() === 'false') {
				...
				self.view.recentActivityComp.isVisible = recentActivityPermission;
                var isWealthUserMultiCustomer = accountsModule.presentationController.isWealthUserMultiCustomer;
            ...
            if (applicationManager.getConfigurationManager().isMicroAppPresent("PortfolioManagementMA") && dateFlag.toString().toLowerCase() === 'true') {
                const wealthPresenter = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({
                    "appName": "PortfolioManagementMA",
                    "moduleName": "WealthPortfolioUIModule"
                }).presentationController;
                wealthPresenter.getBankDate();
            }
        },
        getRecentActivities: function () {
            const isWealthUserMultiCustomer = applicationManager.getModulesPresentationController({ appName: 'HomepageMA', moduleName: 'AccountsUIModule' }).isWealthUserMultiCustomer;
            const checkUserPermission = function(permission) {
                return applicationManager.getConfigurationManager().checkUserPermission(permission);
            }
            const recentActivityPermission = applicationManager.getConfigurationManager().getRecentActivityPermissionsList().some(checkUserPermission);
			this.view.recentActivityComp.isVisible = recentActivityPermission;
            this.view.flxRecentActivity.isVisible = recentActivityPermission;
            const recentActivParams = {
                'coreCustomerId' : isWealthUserMultiCustomer ? scope_WealthPresentationController.selectedCustomerID : '',
                'bankDate': scope_WealthPresentationController.wealthBankDate || '',
            };
            this.view.recentActivityComp.getCustomerId(recentActivParams, recentActivityPermission);
        },
        ...
        */
            ...
            try {
                ...
                tempSbaJourney.map((business, index) => {
                    if (business.BackendId == selectedBusiness.BackendId) {
                        if (tempSbaJourney[index].sbaEnrolmentStatus == "") {
                            tempSbaJourney[index].sbaEnrolmentStatus = {
                                status: "",
                                eventDateTime: ""
                            }
                        }
        ...
        setHamburgerConfig: function () {
            ...
            try {
                ...
                sbaHamburgerConfig.isFromSbaRefresh = true;
