define({
  ...
  setPreShowData : function(){
   ...
   postShow: function(){
	...
	this.view.txtareaDescription.placeholderSkin = "sknTxtAreaSSPREg42424228pxRadius10";
  ...
  onConfirmCancel : function(response){
    ...
    else if(navManager.getEntryPoint("messageCategory") === "frmDisputeTransactionDetails") {
     navManager.navigateTo({
             "appName": "ArrangementsMA",
             "friendlyName": "DisputeTransactionUIModule/frmDisputeTransactionDetails"
         });
    }	       
    }
  },
