...
public class N_SSOFFI extends JSLibrary {
	...
	public static final String sendAppInstalledBroadcast = "sendAppInstalledBroadcast";
 
	String[] methods = { saveToken, getToken, deleteToken, sendAppInstalledBroadcast };
 ...
 ret = this.sendAppInstalledBroadcast( );
 ...
 Boolean val = new Boolean(com.kony.sso.SSOHelper.deleteToken( inputKey0
 	...
 	public final Object[] sendAppInstalledBroadcast( ){
 
		Object[] ret = null;
 com.kony.sso.SSOHelper.sendAppInstalledBroadcast( );
